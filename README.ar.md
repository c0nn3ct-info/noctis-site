...
<p align="center">
  ...
  <a href="https://github.com/c0nn3ct-xyz/noctis-host"><img src="https://img.shields.io/badge/helper-MIT-green" alt="المساعد: MIT"></a>
  <a href="https://noctis.c0nn3ct.xyz"><img src="https://img.shields.io/badge/site-noctis.c0nn3ct.xyz-7c3aed" alt="الموقع"></a>
</p>
...
Noctis إضافة متصفّح مجانية توجّه ترافيك Chrome عبر خوادم VLESS وVMess وTrojan وShadowsocks وHysteria2 وReality وغيرها من خلال مساعد محلي يعمل بـ sing-box. لا VPN على مستوى النظام، ولا نافذة عميل منفصلة — يبقى التوكيل داخل المتصفّح.
...
- **بثّ مباشر للسجلّات** — يُبثّ مخرَجا stdout وstderr من sing-box إلى الإضافة. شخّص مشاكل الاتصال دون مغادرة المتصفّح.
...
يدعم Noctis كل وسيلة نقل يوفّرها sing-box: VLESS (بما في ذلك VLESS Reality) وVMess وTrojan وShadowsocks وHysteria2 وTUIC وWireGuard وAnyTLS وShadowTLS. تعمل إعدادات V2Ray وXray ولوحات 3X-UI كما هي — الصق رابط مشاركة أو رابط اشتراك وتترجمه الإضافة تلقائيًا إلى منفذ صادر في sing-box.

## 🧩 كيف يعمل

لا تستطيع المتصفّحات تشغيل محرّك sing-box بنفسها. تقسّم الأجزاء الثلاثة العمل عبر حدود البيئة المعزولة — والسهم الذي يعبرها هو المكان الوحيد الذي تتدفّق فيه الرسائل.
...
sing-box هو محرّك الوكيل مفتوح المصدر الذي يعمل تحت Noctis. وهو متوافق مع إعدادات V2Ray وXray ويدعم VLESS وVMess وTrojan وShadowsocks وHysteria2 وTUIC وReality وAnyTLS وShadowTLS وWireGuard جاهزة للاستخدام. يتضمّن Noctis مساعدًا أصليًا صغيرًا يشرف على sing-box على جهازك، بحيث لا يكون على إضافة المتصفّح سوى إرسال قرارات التوجيه — دون أي ترافيك خام.

## 📥 التثبيت

تحتاج إضافة Noctis إلى مساعد أصلي صغير يعمل على جهازك. يشرف المساعد على sing-box، المحرّك الذي يقوم فعليًا بالتوكيل.

### قبل أن تبدأ

- متصفّح مبني على Chromium، الإصدار 120 أو أحدث (Chrome وChromium وEdge وBrave وArc وVivaldi وOpera وYandex Browser).
- نحو 50 ميغابايت من مساحة القرص الحرّة للمساعد وsing-box.
...
مصدر المساعد: <https://github.com/c0nn3ct-xyz/noctis-host>
...
يُنزّل المثبّت noctis-host وsing-box إلى دليل بيانات المستخدم ويكتب بيان المراسلة الأصلية لكل متصفّح مدعوم.

في أول مرة تتواصل فيها الإضافة مع المساعد، قد يعرض متصفّحك مطالبة مراسلة أصلية تظهر مرة واحدة — وافِق عليها.

### التشغيل الأول

افتح النافذة المنبثقة للإضافة، والصق رابط مشاركة `vless://` أو `ss://` أو `trojan://` (أو رابط اشتراك)، وبدّل الخادم النشط. يتحوّل شارة الحالة إلى الأخضر بمجرد أن يقبل sing-box الترافيك.
...
نعم. VLESS Reality منفذ صادر قياسي في sing-box، وينقل Noctis معاملات Reality (Server Name وFingerprint وSNI وDest والمفتاح العام وShort ID) إلى المساعد دون تغيير. الصق رابط مشاركة `vless://...flow=xtls-rprx-vision&security=reality` وتستورد الإضافة كل حقل.

**ما بروتوكولات الوكيل التي يدعمها Noctis؟**
VLESS وVMess وTrojan وShadowsocks وHysteria2 وTUIC وWireGuard وAnyTLS وShadowTLS — أي شيء يدعمه sing-box كمنفذ صادر. وتعمل روابط مشاركة V2Ray وXray كما هي.
...
- **[sing-box](https://github.com/SagerNet/sing-box)** — محرّك الوكيل الذي يقوم بكل التوجيه والتشفير الأصلي. Noctis سطح تحكّم؛ وsing-box هو من يقوم بالعمل الفعلي.
- **[V2Ray](https://github.com/v2fly/v2ray-core)** و**[Xray](https://github.com/XTLS/Xray-core)** — تصاميم البروتوكولات الأصلية (VLESS وVMess وReality) التي يتحدّث بها Noctis عبر منافذ صادرة متوافقة مع sing-box.

## ⚖️ الجوانب القانونية

- الترخيص — EULA مملوك: انظر [LICENSE](./LICENSE.md) أو <https://noctis.c0nn3ct.xyz/ar/license/>.
- الخصوصية — انظر [PRIVACY](./PRIVACY.md) أو <https://noctis.c0nn3ct.xyz/ar/privacy/>.
- المساعد الأصلي — بترخيص MIT: انظر <https://github.com/c0nn3ct-xyz/noctis-host>.
